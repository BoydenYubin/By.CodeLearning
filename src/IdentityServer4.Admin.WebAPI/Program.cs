...
namespace IdentityServer4.Admin.WebAPI
{
    public class Program
    {
        ...
        {
            Console.Title = "IdentityServer4 Admin WebAPI Management";
            ...
            Log.Logger = new LoggerConfiguration()
                            ...
                            .WriteTo.File("ByLearning_Admin_log-.txt", rollingInterval: RollingInterval.Day, fileSizeLimitBytes: 1073741824 / 8)
