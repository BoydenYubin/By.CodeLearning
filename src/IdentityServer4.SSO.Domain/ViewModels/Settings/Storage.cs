...
namespace ByLearning.SSO.Domain.ViewModels.Settings
{
    public class StorageSettings
    {
        ...
        /// <param name="virtualPath">For local storage will concate to end of path: https://SSO.ByLearning.net/virtual-path/ </param>
        /// <param name="basePath">The base path to return in local storage: https://SSO.ByLearning.net/ </param>
