...
using IdentityServer4.SSO.WebUI.Models;
...
namespace IdentityServer4.SSO.WebUI.Controllers.Account
{
    public class AccountController : Controller
    {
        ...
        private async Task<SignInResult> DoLogin(UserViewModel userIdentity, bool rememberLogin)
        {
            ...
            if (user == null)
            {
                //RegisterUserLdapViewModel 替换为 SocialViewModel
